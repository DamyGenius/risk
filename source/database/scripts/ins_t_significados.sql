...
insert into t_significados (DOMINIO, CODIGO, SIGNIFICADO, REFERENCIA, ACTIVO)
values ('DOMINIO_SERVICIO', 'AUT', 'AUTENTICACI�N', null, 'S');
...
insert into t_significados (DOMINIO, CODIGO, SIGNIFICADO, REFERENCIA, ACTIVO)
values ('ESTADO_MENSAJE', 'P', 'PENDIENTE DE ENV�O', null, 'S');

insert into t_significados (DOMINIO, CODIGO, SIGNIFICADO, REFERENCIA, ACTIVO)
values ('ESTADO_MENSAJE', 'N', 'EN PROCESO DE ENV�O', null, 'S');
...
insert into t_significados (DOMINIO, CODIGO, SIGNIFICADO, REFERENCIA, ACTIVO)
values ('DOMINIO_SERVICIO', 'MSJ', 'MENSAJER�A', null, 'S');
...
insert into t_significados (DOMINIO, CODIGO, SIGNIFICADO, REFERENCIA, ACTIVO)
values ('ESTADO_CORREO', 'N', 'EN PROCESO DE ENV�O', null, 'S');

insert into t_significados (DOMINIO, CODIGO, SIGNIFICADO, REFERENCIA, ACTIVO)
values ('ESTADO_CORREO', 'P', 'PENDIENTE DE ENV�O', null, 'S');
