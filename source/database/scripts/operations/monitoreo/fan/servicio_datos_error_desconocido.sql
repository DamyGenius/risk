...
begin
  ...
  l_varchar2(1) :=q'!507!';
  l_clob(2) :=q'!M!';
  l_clob(3) :=q'!SERVICIO_DATOS_ERROR_DESCONOCIDO!';
  l_clob(4) :=q'!FAN!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!Error desconocido en driver del servicio de datos!';
  l_clob(7) :=q'!0.1.0!';
  l_varchar2(8) :=q'!1!';
  l_clob(9) :=q'!!';
...
-Verificar compatibilidad del driver con el navegador.!';
  l_varchar2(5) :=q'!1!';
  l_varchar2(6) :=q'!1!';
  l_varchar2(7) :=q'!23.08.2023 01:10:02.710000000 +00:00!';
  l_varchar2(8) :=q'!!';
  l_varchar2(9) :=q'!!';
  l_varchar2(10) :=q'!1!';
  l_varchar2(11) :=q'!2!';
