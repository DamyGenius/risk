...
begin
  ...
  l_varchar2(1) :=q'!2!';
  l_clob(2) :=q'!SERVICIO:FAN:LISTAR_GRUPOS!';
  l_clob(3) :=q'!N!';
  l_clob(4) :=q'!N!';
  l_clob(5) :=q'!N!';
  l_clob(6) :=q'!N!';
