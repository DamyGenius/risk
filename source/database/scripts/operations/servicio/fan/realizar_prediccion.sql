...
begin
  ...
  l_varchar2(1) :=q'!43!';
  l_clob(2) :=q'!S!';
  l_clob(3) :=q'!REALIZAR_PREDICCION!';
  l_clob(4) :=q'!FAN!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!!';
  l_clob(7) :=q'!0.1.0!';
...
begin
  ...
  l_varchar2(1) :=q'!43!';
  l_clob(2) :=q'!GOLES_CLUB_VISITANTE!';
  l_clob(3) :=q'!0.1.0!';
  l_varchar2(4) :=q'!4!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!N!';
...
begin
  ...
  l_varchar2(1) :=q'!2!';
  l_clob(2) :=q'!SERVICIO:FAN:REALIZAR_PREDICCION!';
  l_clob(3) :=q'!N!';
  l_clob(4) :=q'!N!';
  l_clob(5) :=q'!N!';
  l_clob(6) :=q'!N!';
