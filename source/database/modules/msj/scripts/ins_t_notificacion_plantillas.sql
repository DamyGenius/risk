...
insert into t_notificacion_plantillas (ID_APLICACION, ID_PLANTILLA, NOMBRE, ACTIVO, DETALLE, PLANTILLA)
values ('AND', 'EEX', 'ESPECIAL_EXTRAS', 'S', 'Notificaciones especiales con datos extras para la plataforma Android', '{"data":{"title":"$(titulo)","body":"$(contenido)","type":"$(tipo)","id":"$(identificador)","alertOnce":"$(unaAlerta)","data1":"$(dato1)","data2":"$(dato2)","data3":"$(dato3)","image":"$(imagen)"}}');
...
insert into t_notificacion_plantillas (ID_APLICACION, ID_PLANTILLA, NOMBRE, ACTIVO, DETALLE, PLANTILLA)
values ('IOS', 'GEN', 'GENERAL', 'S', 'Notificaciones generales para la plataforma iOS', '{"data":{"title":"$(titulo)","body":"$(contenido)","image":"$(imagen)","largeIcon":"$(icono)"}}');
