...
begin
  ...
  l_varchar2(1) :=q'!83!';
  l_clob(2) :=q'!S!';
  l_clob(3) :=q'!BLOQUEAR_USUARIO!';
  l_clob(4) :=q'!AUT!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!Permite bloquear a un usuario!';
  l_clob(7) :=q'!0.1.0!';
  l_varchar2(8) :=q'!1!';
  l_clob(9) :=q'!!';
...
begin
  ...
  l_varchar2(1) :=q'!2!';
  l_clob(2) :=q'!SERVICIO:AUT:BLOQUEAR_USUARIO!';
  l_clob(3) :=q'!N!';
  l_clob(4) :=q'!N!';
  l_clob(5) :=q'!N!';
  l_clob(6) :=q'!N!';
