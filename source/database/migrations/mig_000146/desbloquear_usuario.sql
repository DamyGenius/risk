...
begin
  ...
  l_varchar2(1) :=q'!84!';
  l_clob(2) :=q'!S!';
  l_clob(3) :=q'!DESBLOQUEAR_USUARIO!';
  l_clob(4) :=q'!AUT!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!Permite desbloquear a un usuario!';
  l_clob(7) :=q'!0.1.0!';
  l_varchar2(8) :=q'!1!';
  l_clob(9) :=q'!!';
...
begin
  ...
  l_varchar2(1) :=q'!84!';
  l_clob(2) :=q'!USUARIO_DESBLOQUEADO!';
  l_clob(3) :=q'!0.1.0!';
  l_varchar2(4) :=q'!1!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!S!';
  ...
  l_clob(10) :=q'!!';
  l_clob(11) :=q'!!';
  l_clob(12) :=q'!Usuario Desbloqueado!';
  l_clob(13) :=q'!!';
  l_clob(14) :=q'!BODY!';
...
begin
  ...
  l_varchar2(1) :=q'!2!';
  l_clob(2) :=q'!SERVICIO:AUT:DESBLOQUEAR_USUARIO!';
  l_clob(3) :=q'!N!';
  l_clob(4) :=q'!N!';
  l_clob(5) :=q'!N!';
  l_clob(6) :=q'!N!';
