...
begin
  ...
  l_varchar2(1) :=q'!505!';
  l_clob(2) :=q'!M!';
  l_clob(3) :=q'!ESCUDOS_PENDIENTES_CLUBES!';
  l_clob(4) :=q'!FAN!';
  l_clob(5) :=q'!S!';
  l_clob(6) :=q'!Clubes sin escudo!';
  l_clob(7) :=q'!0.1.0!';
  l_varchar2(8) :=q'!1!';
  l_clob(9) :=q'!!';
...
begin
  ...
  l_varchar2(1) :=q'!505!';
  l_clob(2) :=q'!Existen clubes sin escudo en el sistema.!';
  l_clob(3) :=q'!SELECT b.id_club, b.nombre_corto, b.id_pais
 ...
 ORDER BY b.id_pais, b.nombre_oficial!';
  l_clob(4) :=q'!Verificar y cargar manualmente los escudos de los clubes pendientes.!';
  l_varchar2(5) :=q'!3!';
  l_varchar2(6) :=q'!!';
  l_varchar2(7) :=q'!!';
  l_varchar2(8) :=q'!!';
